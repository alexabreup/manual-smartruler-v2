...
## 7. Resumo Técnico (Data Sheet)

| Item | Description |
| :--- | :--- |
| **Rated Voltage (MCU)** | 5.0 VDC (Internal) |
| **Operation Voltage (Output)** | 127.0 VAC (K1 - K4) |
| **Input Power (Max Load)** | 10A / 1270W per Channel |
| **Controller Unit** | ESP32-WROOM-32E (Dual Core) |
| **CPU Clock Speed** | 240 MHz |
| **Network Interface** | Ethernet RJ45 Base-T |
| **Logic Pattern** | LOW (0) = ON / HIGH (1) = OFF |
| **Reset Cycle Duration** | 5.0 Seconds |
| **Watchdog Timeout** | 45 Seconds (Hardware Reset) |
| **Operating System** | FreeRTOS Multi-Tasking |
| **Firmware Version** | v1.9.9.1 |
| **PC Monitoring Method** | ARP Scan + JSON ID Verification |
| **Modem Recovery** | Automated K1 Power Cycle |
| **Protection Type** | IP40 (Enclosure) |
| **Lead Connection** | Industrial Screw Terminals |